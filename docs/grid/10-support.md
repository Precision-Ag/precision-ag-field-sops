...
!!! info "AT A GLANCE"
    For grid sampling support, contact **Rachel Brooks** or **David Johnson**.
...
- [ ] Job/grower name and paddock.
- [ ] What step were you on?
- [ ] What did you expect, and what did you see?
- [ ] Any on-screen error text in Fieldmaps, ESRI, or LabStream.

!!! note "NOTE"
    Check [Troubleshooting](09-troubleshooting.md) first. If it's not resolved there,
